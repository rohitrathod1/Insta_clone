...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // SelectTrigger: Input-like styling adjustments
      ...
      // Dark Mode Overrides (Input-like)
      "dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:ring-offset-gray-950 dark:placeholder:text-gray-500 dark:focus:ring-blue-500",
      className
    )}
    {...props}>
    {children}
...
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      align={"start"} // Align content to start by default
      className={cn(
        // SelectContent: Popover-like styling adjustments
...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    // Added dark:text-gray-400 for muted label text
...
const SelectItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // SelectItem: Focus/Hover adjustments
      ...
      // Dark Mode Overrides (Item)
      "dark:focus:bg-gray-700 dark:focus:text-white dark:text-gray-50",
      className
    )}
    {...props}>
